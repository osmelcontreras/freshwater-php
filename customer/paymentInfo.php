...
?>
    <div class="creditCardForm" align="center">
      <div class="heading">
          <h1>Confirm Purchase</h1>
      </div>
      <div class="payment" style="width: 20%;">
          <form action="paymentProcessing.php" method="POST">
              <div class="form-group owner">
                  <label for="owner">Name</label>
                  <input type="text" name="cardFullName" class="form-control" id="owner"
                         title="Please enter your full name as it appears on your card" required>
              </div>
              <div class="form-group CVV">
                  <label for="cvv">CVV</label>
                  <input type="text" class="form-control" id="cvv" name="cvv" min="3"
                         title="Please enter your card security code" required>
              </div>
              <div class="form-group" id="card-number-field">
                  <label for="cardNumber">Card Number</label>
                  <input type="text" class="form-control" id="cardNumber" min="15" name="cardNumber"
